 ...
 public:
  ...
  class VideoRenderer : public rtc::VideoSinkInterface<webrtc::VideoFrame> {
   ...
   protected:
    ...
    HWND wnd_;
    BITMAPINFO bmi_; // 定义了Windows设备无关位图（DIB）的度量和颜色信息
    std::unique_ptr<uint8_t[]> image_; // 渲染显示使用
    CRITICAL_SECTION buffer_lock_;
    rtc::scoped_refptr<webrtc::VideoTrackInterface> rendered_track_; //视频轨，用于渲染
  };
