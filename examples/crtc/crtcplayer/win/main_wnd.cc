...
bool MainWnd::Create() {
  ...
  wnd_ =
      ::CreateWindowExW(WS_EX_OVERLAPPEDWINDOW, kClassName, L"WebrtcPlayer",
...
MainWnd::VideoRenderer::VideoRenderer(
  ...
  // ���ý�����Ƶ���ݵĶ��������Ҫ������Ƶ���ݣ���Ҫʵ��VideoSinkInterface��
  // �˽ӿڱ�¶��OnFrame������ֻҪ��Sinkͨ��AddOrUpdateSink����ע���Source��
  // ��ôSource�ͻ�ͨ��OnFrame�ӿڽ����ݴ���Sink��
