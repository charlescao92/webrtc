...
#ifndef CRTC_RTC_PLAYER_HPP
#define CRTC_RTC_PLAYER_HPP
...
class WebRtcPlayer : public webrtc::PeerConnectionObserver,
                     public webrtc::CreateSessionDescriptionObserver {
 public:
  WebRtcPlayer(MainWindow* main_wnd);
